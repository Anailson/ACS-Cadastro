...
class NasfConductPersistence
{
    ...
    {
        return "INSERT INTO TB_FORWARDING(IN_DAY, SPECIALIZED_SERVICE, CAPS, HOSPITALIZATION, URGENCY, HOME_CARE_SERVICE, INTERSECTORAL) 
            VALUES (:IN_DAY, :SPECIALIZED_SERVICE, :CAPS, :HOSPITALIZATION, :URGENCY, :HOME_CARE_SERVICE, :INTERSECTORAL)";
    }
