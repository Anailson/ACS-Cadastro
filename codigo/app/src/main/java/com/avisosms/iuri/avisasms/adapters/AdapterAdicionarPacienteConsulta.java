 ...
 */
public class AdapterAdicionarPacienteConsulta extends RealmBaseAdapter<Paciente> implements ListAdapter {
    ...
    public AdapterAdicionarPacienteConsulta(Context context, int view, Realm realm, OrderedRealmCollection<Paciente> pacientes, long idConsulta, AdapterListaDePacientes adapterListaPaciente) {
        super(context, pacientes);
        ...
        holder.imgAdicionarNaConsulta.setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        final Consulta consulta = realm.where(Consulta.class).equalTo("id", idConsulta)
                                .findFirst();
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                switch (which) {
                                    case DialogInterface.BUTTON_POSITIVE:
                                        ...
                                        //consulta.getPacientes().where().lessThanOrEqualTo("ordem", 0).findAll();
